<?php
// source: C:\xampp\htdocs\files\food_menu/config/common.neon
// source: C:\xampp\htdocs\files\food_menu/config/local.neon
// source: array
...
class Container_bcc7c358d9 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'App\Presenters\BasePresenter' => [2 => ['application.1']],
		...
		'App\Presenters\IngrediencePresenter' => [2 => ['application.4']],
		'App\Presenters\NutritionPresenter' => [2 => ['application.5']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\files\food_menu\app',
			'wwwDir' => 'C:\xampp\htdocs\files\food_menu\www',
			'vendorDir' => 'C:\xampp\htdocs\files\food_menu\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\files\food_menu/temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\IngrediencePresenter
	{
		$service = new App\Presenters\IngrediencePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__5(): App\Presenters\NutritionPresenter
	{
		$service = new App\Presenters\NutritionPresenter($this->getService('database.default.context'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\files\food_menu/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\files\food_menu/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\files\food_menu/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_bcc7c358d9
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=food_menu', 'root', null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_bcc7c358d9 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\files\food_menu/temp/cache/latte');
