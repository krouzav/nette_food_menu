<?php
// source: C:\xampp\htdocs\files\food_menu\sandbox/config/common.neon
// source: C:\xampp\htdocs\files\food_menu\sandbox/config/local.neon
// source: array
...
class Container_82327d82e0 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\files\food_menu\sandbox\app',
			'wwwDir' => 'C:\xampp\htdocs\files\food_menu\sandbox\www',
			'vendorDir' => 'C:\xampp\htdocs\files\food_menu\sandbox\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\files\food_menu\sandbox/temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\files\food_menu\sandbox/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\files\food_menu\sandbox/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'C:\xampp\htdocs\files\food_menu\sandbox/temp/cache',
			$this->getService('cache.journal')
		);
	}


	public function createServiceContainer(): Container_82327d82e0
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_82327d82e0 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\files\food_menu\sandbox/temp/cache/latte');
